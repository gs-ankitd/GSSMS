...
<head> 
    ...
    <link href="<?php echo base_url(); ?>stylesheets/bootstrap-material-design.css" rel="stylesheet">
	<link rel="stylesheet" href="//cdnjs.cloudflare.com/ajax/libs/bootstrap-material-design/0.2.1/css/material.min.css" />
    <link href="<?php echo base_url(); ?>stylesheets/ripples.min.css" rel="stylesheet">
	<link href="<?php echo base_url(); ?>stylesheets/animsition.css" rel="stylesheet">
	<script src="http://code.jquery.com/jquery-1.10.2.min.js" type="text/javascript"></script>
	<script src="http://code.jquery.com/ui/1.10.3/jquery-ui.js" type="text/javascript"></script>
	<script src="<?php echo base_url(); ?>javascripts/common.js" type="text/javascript"></script>
	...
	<script src="<?php echo base_url(); ?>javascripts/masonry.min.js" type="text/javascript"></script>
	...
	<!--<script src="<?php echo base_url(); ?>javascripts/jquery.validate.min.js" type="text/javascript"></script>-->
	...
	<script src="<?php echo base_url(); ?>javascripts/main.js" type="text/javascript"></script><script src="<?php echo base_url(); ?>javascripts/respond.js" type="text/javascript"></script>
	<!-- Material Design for Bootstrap -->
	<script src="<?php echo base_url(); ?>javascripts/material.js"></script>
	<script src="<?php echo base_url(); ?>javascripts/ripples.min.js"></script>
	<script>
	  //$.material.init();
	   $(function () {
    $.material.init();
	...
	<script src="<?php echo base_url(); ?>javascripts/animsition.js" charset="utf-8"></script>
  <script>
